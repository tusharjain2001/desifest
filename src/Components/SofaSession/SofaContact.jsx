...
const SofaContact = ({ desktopImage, mobileImage, textcolour }) => {
    ...
    return (
        <section
            id="contact"
            className="relative flex min-h-screen w-full ml-0 sm:ml-24 flex-col overflow-hidden md:flex-row"
        >
            {/* DESKTOP IMAGE */}
