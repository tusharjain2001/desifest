        ...
        <section className="w-full bg-transparent py-20 md:px-4">
            ...
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-2 sm:gap-6 md:gap-10 lg:grid-cols-3">
                {partners.map((logo, index) => (
                    <div
                        key={index}
                        className="flex min-h-[110px] items-center justify-center rounded-2xl bg-[#FFFFFF1F] px-6 transition-[border-radius] delay-0 duration-500 ease-in-out hover:rounded-[80px] sm:min-h-[140px] sm:rounded-3xl sm:px-10"
                    >
